...
const GallerieItem = ({item: {uri, id}, onPress}) => {
  return <TouchableOpacity activeOpacity={0.5} onPress={() => onPress()} style={styles.imageWrapper}>
...
const GalleryContainer = ({navigation}) => {
  return <Gallerie onPressItem={(id) => {
